  ...
  return (
    ...
    >
      <div className={`relative flex flex-col items-center justify-center w-full ${scaleClass}`}>
        ...
        {/* Main Stage Viewport - Changed to w-full to span the screen fully without left/right padding */}
        <div className="relative w-full h-[250px] flex items-center justify-center overflow-hidden">
          
          {/* ========================================================= */}
          {/* 1. SEAMLESS MOVING CLOUDS (Wider 1260px loop)             */}
          {/* ========================================================= */}
          ...
          {/* ========================================================= */}
          {/* 2. TALLER SKYLINE (Warehouse scaled up, wider 1260px loop) */}
          {/* ========================================================= */}
          <div className="absolute top-0 left-0 w-full h-[200px] overflow-hidden pointer-events-none z-0">
            <div className="flex w-[1260px] animate-skyline-scroll opacity-85">
              ...
              <svg viewBox="0 0 420 190" className="w-[420px] h-[190px] shrink-0" fill="none">
                {/* 1. CAFKART WAREHOUSE (Made much taller, moved Y up) */}
                <rect x="8" y="30" width="114" height="160" rx="2" fill="#d9ebdf" />
                <path d="M4 30 L65 -5 L126 30 Z" fill="#c3decc" />
                <path d="M8 30 L65 0 L122 30 Z" fill="#b1d3bc" />
                <rect x="6" y="30" width="118" height="6" fill="#c3decc" />
                
                {/* Doors stay near the bottom */}
                ...
                {/* Warehouse Signage moved up */}
                <rect x="25" y="45" width="80" height="20" rx="2" fill="#ffffff" />
                <g transform="translate(56, 47.5) scale(0.012)" className="text-green-600">
                  {CAFKART_LOGO_PATHS}
                </g>

                {/* 2. DIVERSE Building (Stretched up) */}
                <rect x="132" y="38" width="66" height="152" rx="3" fill="#d9ebdf" />
                ...
                <path d="M143 88V76C143 73 145 71 148 71C151 71 153 73 153 76V88H143Z" fill="#f0f7f2" />
                <path d="M160 88V76C160 73 162 71 165 71C168 71 170 73 170 76V88H160Z" fill="#f0f7f2" />
                <path d="M177 88V76C177 73 179 71 182 71C185 71 187 73 187 76V88H177Z" fill="#f0f7f2" />

                {/* 3. DIVERSE Building (Taller) */}
                <rect x="206" y="10" width="68" height="180" fill="#cbe3d3" />
                <rect x="216" y="-16" width="48" height="26" fill="#d9ebdf" />
                <rect x="228" y="-32" width="24" height="16" fill="#e2efe6" />
                <line x1="240" y1="-44" x2="240" y2="-32" stroke="#b1d3bc" strokeWidth="2.5" strokeLinecap="round" />
                <circle cx="224" cy="32" r="2.2" fill="#f0f7f2" />
                <circle cx="240" cy="32" r="2.2" fill="#f0f7f2" />
                <circle cx="256" cy="32" r="2.2" fill="#f0f7f2" />
                <circle cx="224" cy="48" r="2.2" fill="#f0f7f2" />
                <circle cx="240" cy="48" r="2.2" fill="#f0f7f2" />
                <circle cx="256" cy="48" r="2.2" fill="#f0f7f2" />
                <circle cx="224" cy="64" r="2.2" fill="#f0f7f2" />
                <circle cx="240" cy="64" r="2.2" fill="#f0f7f2" />
                <circle cx="256" cy="64" r="2.2" fill="#f0f7f2" />

                {/* 4. DIVERSE Building (Narrow) */}
                <rect x="282" y="25" width="28" height="165" fill="#e2efe6" />
                <ellipse cx="296" cy="25" rx="14" ry="7" fill="#d9ebdf" />
                
                {/* 5. DIVERSE Building (Narrow adjacent) */}
                <rect x="318" y="15" width="26" height="175" fill="#d9ebdf" />
                <ellipse cx="331" cy="15" rx="13" ry="8" fill="#cbe3d3" />
                <rect x="296" y="38" width="35" height="4" fill="#b1d3bc" /> {/* bridge connect */}

                {/* 6. DIVERSE Building */}
                <rect x="352" y="20" width="60" height="170" rx="2" fill="#cbe3d3" />
                <rect x="360" y="25" width="44" height="4" fill="#b1d3bc" />
                <rect x="362" y="36" width="10" height="16" rx="1" fill="#f0f7f2" />
                <rect x="382" y="36" width="10" height="16" rx="1" fill="#f0f7f2" />
                <rect x="362" y="60" width="10" height="16" rx="1" fill="#f0f7f2" />
                <rect x="382" y="60" width="10" height="16" rx="1" fill="#f0f7f2" />
              </svg>
          ...
          <div className="absolute top-[182px] left-0 w-full h-[80px] bg-white z-0" />

          {/* ========================================================= */}
          {/* 3. TRUCK, GROCERIES & WHEELS (Adjusted positions & suspension) */}
          {/* ========================================================= */}
          {/* We use a fixed viewBox to keep the truck centered regardless of screen width */}
          <svg
            viewBox="0 0 360 250"
            className="absolute inset-x-0 mx-auto w-full max-w-[360px] h-[250px] z-10 pointer-events-none"
            fill="none"
          ...
          >
            ...
            <g transform="translate(45, 60) scale(0.18)">
              ...
              <g className="animate-truck-body">
                ...
                {/* 1. GROCERIES: Placed INSIDE the truck (y=20) so they peek out, NOT flying */}
                <g className="animate-produce-jiggle" transform="translate(130, 20) scale(4.5)">
                  {/* Baguette */}
                ...
                {/* 2. CHASSIS WITH SUSPENSION ADDED */}
                <g id="chassis">
                  ...
                  <path d="M390 553 V 604 M 430 553 V 604 M 470 553 V 604 M 510 553 V 604" stroke="#1e293b" strokeWidth="8" />
                  <path d="M400 560 L420 575 M400 590 L420 605" stroke="#64748b" strokeWidth="4" />
                  
                  {/* Front Suspension Details */}
                  <path d="M1140 553 V 604 M 1180 553 V 604 M 1220 553 V 604 M 1260 553 V 604" stroke="#1e293b" strokeWidth="8" />
                ...
                {/* 4. PERFECT LOGO PLACEMENT: Moved UP and SCALED perfectly to fit the container without hitting tires */}
                <g transform="translate(480, 260) scale(0.15)" className="text-white">
                  {CAFKART_LOGO_PATHS}
                </g>
      ...
      <style>{`
        /* Continuous pan for distinct tall buildings - Fixed for 1260px width to loop perfectly */
        ...
        /* Independent grocery wobble - Now perfectly synced inside the moving truck */
        @keyframes produceJiggle {
          0%, 100% { transform: translate(130px, 20px) rotate(0deg); }
          50% { transform: translate(130px, 15px) rotate(-1.5deg); }
        }
