...
export const AppLoader = React.memo(function AppLoader({
  ...
  return (
    ...
    >
      <div className={`relative flex flex-col items-center justify-center w-80 h-52 ${scaleClass}`}>
        {/* Soft Ambient Radial Glow */}
        <div className="absolute h-40 w-64 rounded-full bg-emerald-100/50 blur-3xl pointer-events-none" />

        {/* Speed Wind Streaks behind the Container */}
        <div className="absolute top-11 -left-2 flex flex-col gap-2.5 pointer-events-none opacity-60">
          <div className="h-[2px] w-8 bg-gradient-to-l from-emerald-400 to-transparent rounded-full animate-wind-1" />
          <div className="h-[2px] w-14 bg-gradient-to-l from-emerald-500 to-transparent rounded-full animate-wind-2 ml-3" />
          <div className="h-[2px] w-10 bg-gradient-to-l from-emerald-400 to-transparent rounded-full animate-wind-3 ml-1" />
        </div>
          ...
          >
            <defs>
              ...
              <linearGradient id="cabGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                ...
                <stop offset="100%" stopColor="#011b12" />
              </linearGradient>
            ...
            <polygon points="252,78 270,72 270,86" fill="url(#headlightBeam)" opacity="0.6" />

            {/* 1. CONTAINER CHASSIS & UNDERCARRIAGE */}
            <rect x="14" y="82" width="228" height="6" rx="2" fill="#0f172a" />

            {/* 2. MAIN FREIGHT CONTAINER BOX */}
            <rect
              x="16"
              y="22"
              width="146"
            ...
            {/* Container Corrugated Panel Vertical Grooves */}
            <path
              d="M32 24V82M48 24V82M64 24V82M80 24V82M96 24V82M112 24V82M128 24V82M144 24V82"
              stroke="#012015"
              strokeWidth="1.5"
              opacity="0.35"
            />

            {/* Container Upper Reinforcement Rail */}
            <rect x="16" y="20" width="146" height="4" rx="1.5" fill="#046243" />
            <rect x="16" y="21" width="146" height="1" fill="#59D9B6" opacity="0.6" />

            {/* Modern Mint Accent Stripe at Bottom of Container */}
            <rect x="16" y="78" width="146" height="3.5" fill="#59D9B6" />

            {/* 3. CAFKART SPLASH LOGO PLACED DIRECTLY ON CONTAINER (NO TINT / NO CIRCLE) */}
            <g transform="translate(64, 30) scale(0.026)">
              {/* Exact Splash White Shape */}
              <path
              ...
              {/* Exact Splash Green Gradient Shape */}
              <path
            ...
            {/* 4. TRUCK CABIN FRONT */}
            <path
              d="M166 22H188C194 22 199 25.5 201 31L217 68C219 72 216 77 212 77H166V22Z"
              fill="url(#cabGrad)"
            />

            {/* Windshield */}
            <path
              d="M172 28H187C190 28 193 30 194.5 33L206 58H172V28Z"
              fill="#a7f3d0"
              opacity="0.85"
            />
            {/* Windshield Reflection */}
            <path d="M188 29L198 56H193L184 29H188Z" fill="#ffffff" opacity="0.6" />

            {/* Side Mirror */}
            <rect x="194" y="44" width="3" height="8" rx="1.5" fill="#02402c" />
            <rect x="194" y="46" width="5" height="2" rx="0.5" fill="#64748b" />

            {/* Front Bumper & Grill */}
            <path d="M214 74H236C240 74 243 77 243 81V86H208L214 74Z" fill="#0f172a" />
            <rect x="238" y="77" width="5" height="5" rx="1.5" fill="#fef08a" />
            <rect x="230" y="82" width="12" height="2" rx="1" fill="#475569" />

            {/* 5. WHEEL FENDERS & CHASSIS CUTOUTS */}
            <path
              d="M12 86H36C38 86 40 84 40 82C40 72 50 64 60 64C70 64 80 72 80 82C80 84 82 86 84 86H92C94 86 96 84 96 82C96 72 106 64 116 64C126 64 136 72 136 82C136 84 138 86 140 86H178C180 86 182 84 182 82C182 72 192 64 202 64C212 64 222 72 222 82C222 84 224 86 226 86H246V90H12V86Z"
              fill="#0f172a"
            />

            {/* 6. WHEELS: TANDEM REAR + FRONT STEERING */}
            {/* Wheel 1 (Rear tandem 1) */}
            <g className="animate-spin-wheel origin-[60px_86px]">
              <circle cx="60" cy="86" r="16" fill="#1e293b" />
              <circle cx="60" cy="86" r="10" fill="#64748b" />
              <circle cx="60" cy="86" r="4" fill="#f8fafc" />
              <line x1="60" y1="76" x2="60" y2="96" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
              <line x1="50" y1="86" x2="70" y2="86" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
            </g>

            {/* Wheel 2 (Rear tandem 2) */}
            <g className="animate-spin-wheel origin-[116px_86px]">
              <circle cx="116" cy="86" r="16" fill="#1e293b" />
              <circle cx="116" cy="86" r="10" fill="#64748b" />
              <circle cx="116" cy="86" r="4" fill="#f8fafc" />
              <line x1="116" y1="76" x2="116" y2="96" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
              <line x1="106" y1="86" x2="126" y2="86" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
            </g>

            {/* Wheel 3 (Front Cab) */}
            <g className="animate-spin-wheel origin-[202px_86px]">
              <circle cx="202" cy="86" r="16" fill="#1e293b" />
              <circle cx="202" cy="86" r="10" fill="#64748b" />
              <circle cx="202" cy="86" r="4" fill="#f8fafc" />
              <line x1="202" y1="76" x2="202" y2="96" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
              <line x1="192" y1="86" x2="212" y2="86" stroke="#f8fafc" strokeWidth="2" strokeLinecap="round" />
            </g>
          </svg>
        </div>

        {/* ----------------- SPEED ROAD SURFACE ----------------- */}
        <div className="relative -mt-3 h-1.5 w-64 overflow-hidden rounded-full bg-slate-100 flex items-center">
          <div className="animate-road-speed h-full w-full bg-[repeating-linear-gradient(90deg,#02402c_0px,#02402c_18px,transparent_18px,transparent_36px)]" />
        </div>

        {/* Dynamic Ground Shadow */}
        <div className="h-2 w-56 rounded-full bg-slate-400/30 blur-xs animate-shadow-run -mt-1" />
      </div>
