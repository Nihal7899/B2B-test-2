...
export const AppLoader = React.memo(function AppLoader({
  ...
  return (
    ...
    >
      <div className={`relative flex flex-col items-center justify-center w-64 h-36 ${scaleClass}`}>
        ...
        <div className="absolute top-9 left-2 flex flex-col gap-2 pointer-events-none opacity-60">
          ...
          <div className="h-[2px] w-7 bg-gradient-to-l from-emerald-400 to-transparent rounded-full animate-wind-3 ml-1" />
        </div>

        {/* ----------------- 2-TYRE CARGO CONTAINER TRUCK ----------------- */}
        <div className="relative z-10 animate-truck-drive">
          ...
          >
            ...
            {/* Headlight Beam */}
            <polygon points="186,60 200,56 200,66" fill="url(#headlightBeam)" opacity="0.6" />

            {/* 1. FREIGHT CONTAINER BOX */}
            <rect
              x="16"
              y="16"
              width="106"
            ...
            {/* Container Vertical Corrugation Slat Lines */}
            <path
              d="M28 18V64M40 18V64M52 18V64M64 18V64M76 18V64M88 18V64M100 18V64M112 18V64"
              stroke="#012015"
              strokeWidth="1.2"
              opacity="0.3"
            />
            ...
            <rect x="16" y="15" width="106" height="3" rx="1" fill="#046243" />
            <rect x="16" y="16" width="106" height="0.8" fill="#59D9B6" opacity="0.5" />
            <rect x="16" y="61" width="106" height="3" fill="#59D9B6" />

            {/* 2. DIRECT CAFKART SPLASH LOGO (NO CIRCLE, NO TINT) */}
            <g transform="translate(50, 22) scale(0.021)">
            ...
            {/* 3. MODERN CAB-OVER CABIN */}
            <path
              d="M122 18H148C154 18 158.5 21 160.5 26L172 54C173.5 58 171 62 167 62H122V18Z"
              fill="url(#cabGrad)"
            />

            {/* Aerodynamic Windshield */}
            <path
              d="M128 22H147C149.5 22 151.8 23.8 152.8 26.2L162 48H128V22Z"
              fill="#a7f3d0"
              opacity="0.85"
            />
            <path d="M145 23L154 44H150L142 23H145Z" fill="#ffffff" opacity="0.6" />

            {/* Side Mirror */}
            <rect x="151" y="36" width="2.5" height="7" rx="1.2" fill="#02402c" />
            <rect x="151" y="38" width="4.5" height="1.5" rx="0.5" fill="#64748b" />

            {/* Front Grill & Headlight Bumper */}
            <path d="M168 58H184C187 58 189 60 189 63V68H164L168 58Z" fill="#0f172a" />
            <rect x="185" y="60" width="4" height="4" rx="1" fill="#fef08a" />
            <rect x="178" y="64" width="9" height="1.5" rx="0.7" fill="#475569" />

            {/* 4. UNDERCARRIAGE WITH 2 WHEEL ARCHES ONLY */}
            <path
              d="M12 68H32C34 68 36 66 36 64C36 53 46 45 57 45C68 45 78 53 78 64C78 66 80 68 82 68H132C134 68 136 66 136 64C136 53 146 45 157 45C168 45 178 53 178 64C178 66 180 68 182 68H190V72H12V68Z"
              fill="#0f172a"
            />

            {/* 5. EXACTLY TWO TYRES */}
            {/* TYRE 1: REAR WHEEL */}
            <g className="animate-spin-wheel origin-[57px_68px]">
              <circle cx="57" cy="68" r="14" fill="#1e293b" />
              <circle cx="57" cy="68" r="8.5" fill="#64748b" />
              <circle cx="57" cy="68" r="3.5" fill="#f8fafc" />
              <line x1="57" y1="59.5" x2="57" y2="76.5" stroke="#f8fafc" strokeWidth="1.8" strokeLinecap="round" />
              <line x1="48.5" y1="68" x2="65.5" y2="68" stroke="#f8fafc" strokeWidth="1.8" strokeLinecap="round" />
            </g>

            {/* TYRE 2: FRONT CABIN WHEEL */}
            <g className="animate-spin-wheel origin-[157px_68px]">
              <circle cx="157" cy="68" r="14" fill="#1e293b" />
              <circle cx="157" cy="68" r="8.5" fill="#64748b" />
              <circle cx="157" cy="68" r="3.5" fill="#f8fafc" />
              <line x1="157" y1="59.5" x2="157" y2="76.5" stroke="#f8fafc" strokeWidth="1.8" strokeLinecap="round" />
              <line x1="148.5" y1="68" x2="165.5" y2="68" stroke="#f8fafc" strokeWidth="1.8" strokeLinecap="round" />
            </g>
          </svg>
        </div>
      ...
      {/* ----------------- OPTIONAL STATUS TEXT (For Home Screen) ----------------- */}
      {showStatus && (
