  ...
  return (
    ...
    >
      ...
      <p
        ...
        } font-semibold text-ink-700 mt-1.5 leading-tight line-clamp-2`}
      >
        {category.name}
      </p>
      {!compact && (
        <p className="text-[10px] text-ink-400 mt-0.5">{category.count} items</p>
      )}
    </button>
  );
});
...
export const CategoryCarousel = React.memo(function CategoryCarousel({
  categories,
  onCategoryClick,
