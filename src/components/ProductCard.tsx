...
export const ProductCard = React.memo(
  function ProductCard({
    ...
    const hasValidImage = Boolean(product.image && !imageError);
      ...
      >
        ...
        <div className="relative flex h-[135px] w-full items-center justify-center overflow-hidden bg-slate-50">
          ...
          <button
            ...
            className="absolute right-2 top-2 z-10 flex h-7 w-7 items-center justify-center rounded-full bg-white/95 text-slate-500 shadow-xs"
