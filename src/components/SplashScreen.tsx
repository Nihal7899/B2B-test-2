      ...
      <div className="relative w-full h-full select-none">
        ...
        >
          ...
          <div className="mt-3.5 flex items-center gap-2.5">
            ...
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.32em] text-[#e7f3da]">
              B 2 B . H O R E C A
            </span>
            <div className="h-[1.5px] w-6 sm:w-8 bg-[#89c74e] rounded-full" />
          </div>
        ...
        >
          <div className="splash-bar h-full rounded-full bg-gradient-to-r from-[#89c74e] via-[#a8db7a] to-white" />
        </div>

        <p
          className={`absolute bottom-6 left-1/2 -translate-x-1/2 text-[10px] font-semibold tracking-wider text-[#89c74e]/70 uppercase w-full text-center transition-opacity duration-700 delay-300 transform-gpu ${
            showText ? 'opacity-100' : 'opacity-0'
          }`}
        >
