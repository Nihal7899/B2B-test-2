...
function CafKartLogo({ className = 'h-8 w-8' }: { className?: string }) {
  return (
    ...
    >
      <defs>
        <linearGradient id="cafKartGrad" x1="0%" y1="0%" x2="100%" y2="100%">
...
// 2. Custom Electric Fleet Truck SVG Graphic
    ...
    >
      <defs>
        <linearGradient id="bodyGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#0a4837" />
          <stop offset="100%" stopColor="#04261c" />
        </linearGradient>
        <linearGradient id="trailGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stopColor="#59D9B6" stopOpacity="0" />
          <stop offset="100%" stopColor="#59D9B6" stopOpacity="0.6" />
        </linearGradient>
      </defs>

      {/* Speed Trails */}
      <line x1="8" y1="36" x2="84" y2="36" stroke="url(#trailGrad)" strokeWidth="3" strokeLinecap="round" />
      <line x1="24" y1="52" x2="100" y2="52" stroke="url(#trailGrad)" strokeWidth="3.5" strokeLinecap="round" />
      <line x1="14" y1="68" x2="90" y2="68" stroke="url(#trailGrad)" strokeWidth="2.5" strokeLinecap="round" />

      {/* Ground Glow Shadow */}
      <ellipse cx="152" cy="104" rx="70" ry="6" fill="#011a13" fillOpacity="0.6" />

      {/* Cargo Container */}
      <rect x="88" y="26" width="82" height="64" rx="10" fill="url(#bodyGrad)" stroke="#166547" strokeWidth="1.5" />
      <path d="M 88 78 L 170 78" stroke="#0e5338" strokeWidth="2" />
      
      {/* Container Branding Mark */}
      <circle cx="129" cy="52" r="13" fill="#032117" stroke="#59D9B6" strokeWidth="1.5" />
      <path d="M 124 52 L 128 48 L 135 55" stroke="#59D9B6" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />

      {/* Cabin Body */}
      <path
        d="M 168 44 L 186 44 C 196 44 204 51 207 61 L 213 80 C 214 84 211 90 206 90 L 168 90 Z"
        fill="#FFFFFF"
      />
      {/* Windshield */}
      <path
        d="M 174 48 L 186 48 C 192 48 197 53 199 60 L 204 70 L 174 70 Z"
        fill="#0f172a"
      />
      {/* Headlight */}
      <rect x="209" y="78" width="4" height="6" rx="1.5" fill="#59D9B6" />
      {/* Mint Cabin Stripe */}
      <rect x="174" y="78" width="28" height="3" rx="1.5" fill="#59D9B6" />

      {/* Rear Wheel */}
      <circle cx="116" cy="93" r="13" fill="#0f172a" />
      <circle cx="116" cy="93" r="7" fill="#334155" />
      <circle cx="116" cy="93" r="3.5" fill="#59D9B6" />

      {/* Front Wheel */}
      <circle cx="190" cy="93" r="13" fill="#0f172a" />
      <circle cx="190" cy="93" r="7" fill="#334155" />
      <circle cx="190" cy="93" r="3.5" fill="#59D9B6" />

      {/* Floating GPS Beacon Accent */}
      <g transform="translate(215, 22)">
        <circle cx="9" cy="9" r="9" fill="#063a2c" stroke="#59D9B6" strokeWidth="1.5" />
        <circle cx="9" cy="8" r="3.5" fill="#59D9B6" />
        <path d="M 9 12 L 9 15" stroke="#59D9B6" strokeWidth="2" strokeLinecap="round" />
      </g>
    </svg>
  );
}
...
export function DeliveryScreen({
  ...
  // Exact Dashboard Metrics Restored
  ...
  return (
    <div className="min-h-screen bg-[#f4f7f5] flex flex-col justify-between pb-28">
      ...
      <div>
        {/* COMPACT STICKY HEADER WITH CAFKART LOGO & TRUCK GRAPHIC */}
        <header className="sticky top-0 z-40 bg-gradient-to-b from-[#063a2c] via-[#084534] to-[#0a4d3b] text-white pt-[max(0.6rem,env(safe-area-inset-top))] pb-3.5 px-4 sm:px-6 shadow-md border-b border-[#0d5944]">
          <div className="max-w-xl mx-auto space-y-2.5">
            ...
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                {/* Fixed CafKart Exact Vector Logo */}
            ...
            {/* Compact Hero Banner: Greeting + Truck Graphic */}
            <div className="flex items-center justify-between pt-0.5">
              ...
              {/* Delivery Truck SVG */}
              <div className="w-[38%] max-w-[130px] -mr-1">
                <DeliveryTruckGraphic className="w-full h-auto drop-shadow-sm" />
              </div>
            </div>
          </div>
        </header>
        ...
        <main className="px-4 sm:px-6 pt-4 max-w-xl mx-auto space-y-4">
          ...
          {navTab === 'dashboard' && (
            <div className="space-y-4">
              {/* 1. Modern Fintech Cash Remittance Hero Card */}
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-emerald-500/20 text-xs">
                    <p className="text-[11px] text-emerald-200/80 font-medium">
                      {totalSettledWithAdmin > 0
                        ? `₹${totalSettledWithAdmin.toLocaleString('en-IN')} cleared with admin to date`
                        : 'Hand over collected cash at hub dispatch'}
                    </p>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="bg-white border border-slate-200/80 rounded-[22px] p-4 shadow-sm space-y-1 hover:border-indigo-300 transition-all">
                  <div className="flex items-center justify-between">
                    <span className="text-[10px] font-black uppercase tracking-wider text-slate-400">Total Cleared</span>
                  ...
                  <p className="text-[10px] text-indigo-700 font-bold">Reconciled lifetime</p>
                </div>
              </div>

              {/* 3. Spotlight Current Order Flow Card */}
              {activeSpotlight ? (
                <div className="space-y-3">
                  ...
                  <div className="bg-white border border-slate-200/80 rounded-[22px] p-3.5 shadow-sm flex items-center justify-between gap-3">
                    ...
                    <button
                      onClick={() => showToast('Opening warehouse GPS...', 'info')}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-50 border border-slate-200 hover:border-emerald-300 text-xs font-black text-slate-800 shadow-2xs active:scale-95 transition-all shrink-0"
                    >
                  ...
                  {currentOrderList.map(({ assignment, order, items, address, paymentSummary: pay }) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {/* Customer Address & Improved Navigation Pills */}
                        {address && (
          ...
          {/* TAB 5: DRIVER ACCOUNT & CLEARANCES */}
          {navTab === 'account' && (
            <div className="space-y-4">
              ...
              <div className="bg-white border border-slate-200/80 rounded-[22px] p-4 shadow-sm space-y-2.5 text-xs">
                <div className="flex justify-between py-1.5 border-b border-slate-100">
                  <span className="text-slate-500 font-semibold">Net COD to Deposit</span>
                  <span className="font-black text-amber-700">₹{netCodCashToDeposit.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between py-1.5 border-b border-slate-100">
                  <span className="text-slate-500 font-semibold">Total Handed to Admin</span>
                  <span className="font-black text-emerald-700">₹{totalSettledWithAdmin.toLocaleString('en-IN')}</span>
                </div>
                <div className="flex justify-between py-1.5">
                  <span className="text-slate-500 font-semibold">Completed Runs</span>
                  <span className="font-black text-emerald-600">{deliveredList.length}</span>
                </div>
              </div>

              {/* Settlement Receipts */}
              <div className="bg-white border border-slate-200/80 rounded-[22px] p-4 shadow-sm space-y-3">
                      ...
                      <div key={s.id} className="pt-2 first:pt-0 flex justify-between items-start text-xs">
                        <div>
                          <div className="flex items-center gap-1.5 font-bold text-slate-800">
                            ...
                            <span className="text-[9px] uppercase px-1.5 py-0.5 rounded font-black bg-emerald-50 text-emerald-800 border border-emerald-200">
