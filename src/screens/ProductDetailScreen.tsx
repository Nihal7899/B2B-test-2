...
// Default theme for non-store product details
const defaultTheme = {
  primaryColor: '#10b981',
...
function ProductDetailWithStoreTheme({ productId, cart, onBack, onProduct }: ProductDetailScreenProps) {
  ...
  if (storeId) {
    return (
      <StoreProvider storeId={storeId}>
        <ProductDetailWithStoreTheme {...props} />
      </StoreProvider>
    );
  }

  // If no storeId, render without StoreProvider (uses default theme)
