...
import { StoreProvider, useStore, useStoreTheme } from '@/context/StoreContext';
...
// Component that uses the store theme
...
export function ProductDetailScreen(props: ProductDetailScreenProps) {
  ...
  // If no storeId, render without StoreProvider (uses global theme or default)
